...
catalogItem2 = CatalogItem(name="Harness", description="Set of straps that are \
                           adjustable. The straps go through both legs and \
                           sit at your hips. The rope goes through the front \
                           circle loop.", sport=sport6)
session.add(catalogItem2)
session.commit()

catalogItem3 = CatalogItem(name="Rock Climbing Shoes", description="Shoes with \
                           grip on the bottom to help you grab onto the \
                           wall.", sport=sport6)
session.add(catalogItem3)
session.commit()
...
catalogItem1 = CatalogItem(name="Foosball Table", description="A table with 4 \
                           ...
                           table allows the players to turn the handles and \
                           try to score a goal with the ball in the center.",
                           sport=sport7)
session.add(catalogItem1)
session.commit()
